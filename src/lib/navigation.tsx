...
export type PageKey = 'dashboard' | 'completion' | 'teacher-change' | 'tickets' | 'office-hours' | 'teacher-schedule' | 'resale' | 'teachers' | 'final-sessions';
...
export const NAV_ITEMS: Record<PageKey, NavConfig> = {
  ...
  'final-sessions': {
    label: 'Giám khảo Cuối khoá',
    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M12 2L2 7l10 5 10-5-10-5z" />
      <path d="M2 17l10 5 10-5" />
      <path d="M2 12l10 5 10-5" />
    </svg>,
    route: '/admin/final-sessions',
  },
};
